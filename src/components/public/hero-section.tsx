...
export function HeroSection({ content }: { content: HeroContent }) {
  return (
    <section className="relative min-h-[calc(100vh-158px)] overflow-hidden pb-[84px] pt-20 max-md:min-h-[clamp(760px,154vw,900px)] max-md:overflow-hidden max-md:pb-16 max-md:pt-12">
      ...
      <div className="site-shell relative z-10 min-h-[506px] max-md:min-h-[clamp(570px,122vw,700px)]">
        ...
        <img src="/images/figma/asterisk.svg" alt="" className="spin-clockwise absolute right-0 top-[220px] size-20 max-md:right-6 max-md:top-[clamp(605px,96vw,620px)]" />
      </div>
    </section>
  );
}
